...
const baseTranslations = {
  ...
  footer: {
    ...
    explore: "Explore",
    trust: "Trust",
    privacy: "Privacy Policy text coming soon",
    googleNote: "Google Business note coming soon",
    terms: "Terms text coming soon",
    contact: "Contact",
    contactText:
...
const overrides = {
  fr: {
    ...
    footer: {
      explore: "Explorer",
      trust: "Confiance",
      privacy: "Texte de politique de confidentialite bientot disponible",
      googleNote: "Note Google Business bientot disponible",
      terms: "Texte des conditions bientot disponible",
      contactText:
  ...
  es: {
    ...
    footer: {
      explore: "Explorar",
      trust: "Confianza",
      privacy: "Texto de politica de privacidad proximamente",
      googleNote: "Nota de Google Business proximamente",
      terms: "Texto de terminos proximamente",
      contact: "Contacto",
      language: "Idioma",
    },
    home: {
  ...
  ar: {
    ...
    footer: {
      explore: "استكشف",
      trust: "الثقة",
      privacy: "نص سياسة الخصوصية قريبا",
      googleNote: "ملاحظة Google Business قريبا",
      terms: "نص الشروط قريبا",
      contact: "تواصل",
      language: "اللغة",
    },
    home: {
  ...
  de: {
    ...
    footer: {
      explore: "Entdecken",
      trust: "Vertrauen",
      privacy: "Datenschutzhinweis folgt",
      googleNote: "Google-Business-Hinweis folgt",
      terms: "AGB-Hinweis folgt",
      contact: "Kontakt",
      language: "Sprache",
    },
    home: {
